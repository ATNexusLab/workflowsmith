<!-- common fragment: closeout-protocol — loaded via @import or read_file -->
...
| 9 | Multi-phase session or real learning occurred? | Write (once, condensed) | `sessions/YYYY-MM-DD-{slug}.md` in the **vault** |
