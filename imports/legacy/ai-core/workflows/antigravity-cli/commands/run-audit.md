---
description: Run a full security audit on a specified module, file path, or surface area — invokes @engine with the security-audit skill.
---
...
Accepted inputs: a module name, file path, feature area, or surface description (e.g. `src/auth/`, `the payment flow`, `all API endpoints`).
