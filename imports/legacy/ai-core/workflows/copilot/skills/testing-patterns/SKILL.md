...
triggers:
  - "define a test strategy for a feature or project"
  - "write unit, integration, or E2E tests"
  - "improve coverage or choose mocks, stubs, fakes, or spies"
license: MIT
---
...
The global `copilot-instructions.md` is the source of truth for mandatory cross-cutting requirements such as threat-model coverage, three-axis validation, and closeout. This skill does **not** duplicate those tables.
