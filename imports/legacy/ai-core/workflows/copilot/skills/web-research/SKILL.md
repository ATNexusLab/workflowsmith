...
triggers:
  - "find official documentation for a library or framework"
  - "validate technical information against a primary source"
  - "compare API versions or synthesize multiple sources"
  - "search the web, look up the latest version, or verify a URL or official docs"
license: MIT
---
