...
triggers:
  ...
  - "work on Docker, Compose, or infrastructure as code"
  - "define deployment strategy, environments, or secret management"
license: MIT
---
...
Complete the `## Infrastructure Checklist` before production rollout.
