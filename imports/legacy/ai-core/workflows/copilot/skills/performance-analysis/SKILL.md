...
triggers:
  - "a system, endpoint, query, or workload is slow"
  - "identify bottlenecks before optimizing"
  - "profiling, benchmarking, or defining performance budgets"
license: MIT
---
...
Use `## Analysis Checklist` before closing the investigation.
