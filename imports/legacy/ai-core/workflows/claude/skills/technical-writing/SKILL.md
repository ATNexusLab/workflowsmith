...
when_to_use: >
  Use when writing or updating README, CONTRIBUTING, or CHANGELOG, creating API docs, runbooks, or onboarding guides, or writing any human-facing technical documentation.
---
...
- Documentation and UI language should follow the project contract in `CLAUDE.md`
